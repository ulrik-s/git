...
from the first client, clones a fresh `client2` after those pushes to demonstrate a
"smart" clone that only downloads the final 2 MiB blob, and prints a size summary for
each repository.
